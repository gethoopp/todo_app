...
void _categorySerialize(
  ...
  writer.writeString(offsets[0], object.icons);
}
...
Category _categoryDeserialize(
  ...
  object.icons = reader.readStringOrNull(offsets[0]);
  object.id = id;
  return object;
}
...
extension CategoryQueryFilter
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconsIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconsEqualTo(
    String? value, {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconsGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconsLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconsBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconsStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconsEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconsContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconsMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'icons',
        value: '',
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'icons',
        value: '',
...
extension CategoryQuerySortBy on QueryBuilder<Category, Category, QSortBy> {
  QueryBuilder<Category, Category, QAfterSortBy> sortByIcons() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'icons', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByIconsDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQuerySortThenBy
  ...
  QueryBuilder<Category, Category, QAfterSortBy> thenByIcons() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'icons', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByIconsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'icons', Sort.desc);
    });
  }
...
extension CategoryQueryWhereDistinct
  ...
  QueryBuilder<Category, Category, QDistinct> distinctByIcons(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQueryProperty
  ...
  QueryBuilder<Category, String?, QQueryOperations> iconsProperty() {
    return QueryBuilder.apply(this, (query) {
